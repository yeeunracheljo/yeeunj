...
export default function TableOfContents() {
  ...
  const tocItems = [
    ...
    { id: "goal", label: t('toc.goal') },
    { id: "swot", label: t('toc.swot') },
    { id: "benchmark", label: t('toc.benchmark') },
            ...
            return (
              <button
                ...
                className={`shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 rounded-md text-xs md:text-sm font-medium whitespace-nowrap transition-all duration-200 cursor-pointer ${
                  isActive
                    ? 'bg-[#94173F]/10 text-[#94173F]'
                    : 'text-gray-500 hover:text-gray-800 hover:bg-gray-50'
                }`}
              >
                <span className={`text-[10px] font-mono ${isActive ? 'text-[#94173F]' : 'text-gray-300'}`}>
