  ...
  return (
    <section id="introduction" className="py-24 md:py-32 bg-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-serif text-gray-900 leading-tight mb-12 text-center whitespace-pre-line">
          {t('intro.title')}
        </h2>
        ...
        <div className="space-y-4">
          {contexts.map((item, index) => (
            <div
              key={index}
              className="flex items-start gap-4 p-6 bg-[#fbffab]/10 rounded-xl border border-gray-200 hover:border-[#fbffab] transition-colors hover:shadow-md"
            >
              <div className="w-10 h-10 rounded-full bg-[#fbffab] text-[#8B6914] flex items-center justify-center text-sm font-semibold shrink-0">
