      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 md:px-10 py-4 md:py-5 flex items-center justify-between bg-white/80 backdrop-blur-sm border-b border-gray-100">
        ...
        <div className="hidden md:flex items-center gap-10">
          <button
            ...
            className="text-[#333] text-base font-medium flex items-center gap-2 cursor-pointer"
          >
          ...
          <button
            ...
            className="text-gray-400 text-base hover:text-[#333] transition-colors cursor-pointer"
          >
            {t('nav.about')}
          </button>
          <button
