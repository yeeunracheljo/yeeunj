                  ...
                  <div className="rounded-xl bg-[#FAF9F6] border border-[#E8E0D8] p-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {contentStats.map((item) => (
                        <div key={item.label} className="rounded-lg bg-white border border-[#E8E0D8] px-3 py-2 flex items-center justify-between gap-3">
                          <p className="text-[11px] text-[#8A7A72] leading-tight">{item.label}</p>
                          <p className="text-sm font-semibold text-[#3A210F] leading-tight tabular-nums whitespace-nowrap">{item.value}</p>
                        </div>
                      ))}
                    </div>
                  </div>
