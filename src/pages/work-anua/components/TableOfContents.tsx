...
export default function TableOfContents() {
  ...
  const tocItems = [
    ...
    { id: "campaign", label: t('toc.campaign') },
    { id: "research-process", label: t('toc.research') },
    { id: "personas", label: t('toc.personas') },
    { id: "findings", label: t('toc.findings') },
        ...
        <nav className="flex items-center justify-center gap-1 overflow-x-auto py-2.5 no-scrollbar">
          {tocItems.map((item, index) => {
            ...
            return (
              ...
              >
                <span className={`text-[10px] font-mono ${isActive ? 'text-[#14B8A6]' : 'text-gray-300'}`}>
